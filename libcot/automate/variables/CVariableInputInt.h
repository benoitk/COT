...
public:
    CVariableInputInt(CAutomate* arg_automate, QObject *parent = Q_NULLPTR);
    CVariableInputInt(const QMap<QString, QVariant> &mapVar, CAutomate* arg_automate, QObject *parent);
    ~CVariableInputInt();
